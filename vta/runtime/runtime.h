...
TVM_DLL void VTAtest(VTACommandHandle cmd);

TVM_DLL void VTAstart_timer(VTACommandHandle cmd, int num, int is_conv2d);

TVM_DLL void VTAstop_timer(VTACommandHandle cmd, int num, int is_conv2d);

TVM_DLL void VTAconv2d(VTACommandHandle cmd, int num, float* conv2d_input_1, float* conv2d_input_2, float* conv2d_output,
...
TVM_DLL void VTA_print_conv2d(VTACommandHandle cmd,
						int conv2d_input_1_shape0, int conv2d_input_1_shape1, int conv2d_input_1_shape2, int conv2d_input_1_shape3,
						int conv2d_input_2_shape0, int conv2d_input_2_shape1, int conv2d_input_2_shape2, int conv2d_input_2_shape3,
